...
import 'package:Parcelo/features/admin/user_management/presentation/components/user_management_body.dart';
...
class UserManagementScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => UserManagementCubit()..fetchAllUsers(),
      child: Scaffold(
        backgroundColor: context.color.greenDark,
        body: SafeArea(child: UserManagementBody()),
      ),
    );
  }
}
