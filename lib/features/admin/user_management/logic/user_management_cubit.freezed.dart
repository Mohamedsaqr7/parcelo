...
class _$successImpl implements success {
  const _$successImpl({required final List<UserModel> users}) : _users = users;
  ...
  @override
  String toString() {
    return 'UserManagementState.success(users: $users)';
  }
...
abstract class success implements UserManagementState {
  const factory success({required final List<UserModel> users}) = _$successImpl;
