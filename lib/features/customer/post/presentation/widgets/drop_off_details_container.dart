...
class DropOffDetailsContainer extends StatelessWidget {
  const DropOffDetailsContainer({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                PickUpDetailsTextField(
                    ...
                    final result = await Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) => const MapPickerScreen(
                            pickerType: MapPickerType.end),
                      ),
                    );

                    if (result != null && result is String) {
                      cubit.dropOffAddressController.text = result;
                    }
                  },
                  validator: (value) {
                  ...
                  hintText: context.translate(LangKeys.dropOffaddress),
                ...
                //       context,
                //       MaterialPageRoute(
                // builder: (_) => const MapPickerScreen(pickerType: MapPickerType.end),
                //       ),
                //     );
                ...
                //     return null;
                //   },
                //   hintText: context.translate(LangKeys.dropOffaddress) ?? 'Enter drop-off address',
                //   controller: cubit.dropOffAddressController,
                //   prefixIcon: Icon(Icons.location_on, color: context.color.greenDark),
                // )
                // ,
                verticalSpace(10.h),
                PickUpDetailsTextField(
                  ...
                  hintText: context.translate(LangKeys.dropOffName),
                  controller: cubit.dropOffNameController,
                  prefixIcon: Icon(
                    Icons.person,
                    color: context.color.greenDark,
                  ),
                ...
                PickUpDetailsTextField(
                  ...
                  hintText: context.translate(LangKeys.dropOffPhone),
                  controller: cubit.dropOffPhoneController,
                  prefixIcon: Icon(
                    Icons.phone,
                    color: context.color.greenDark,
                  ),
